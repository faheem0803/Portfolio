...
document.addEventListener('DOMContentLoaded', () => {
	const texts = document.querySelectorAll('#typing-container b');
	let index = 0;
  
	function typeText() {
	  texts.forEach(text => text.style.display = 'none'); // Hide all text
	  ...
	  setTimeout(typeText, 2000); // Change text every 4 seconds
	}
